...
### [pending] T2.3: Implement mutual TLS for trunks
...
### [pending] T3.2: Add rotation monitoring
...
### [pending] T4.1: Configure RTPengine for SRTP
...
### [pending] T4.2: Update OpenSIPS SDP routes for SRTP
...
### [pending] T4.3: Handle SDP re-INVITE for SRTP
...
### [pending] T5.1: Restrict TLS cipher suites
...
### [pending] T5.2: Restrict SRTP cipher suites
