...
description: Generate audience-specific reports (stakeholder, architect, dev, SDET,
  and conditionally security) from locked evidence. Non-blocking and re-runnable.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: brownkit:commands/report.md
---
...
- Use `.specify/templates/reports/*.md` as skeletons. Populate every section; if a
