# Tasks: TSiSIP Control Panel Rebranding & Modernization
...
### [completed] T001 Create TSiSIP theme directory structure
...
### [completed] T002 Initialize asset build pipeline configuration
...
### [completed] T003 Create theme.json design token source
...
### [completed] T004 Generate CSS custom properties from theme.json
...
### [completed] T005 Create TSiSIP logo SVG assets
...
### [completed] T006 Build core theme CSS override layer
...
### [completed] T007 Create asset manifest generator
...
### [completed] T008 Integrate asset manifest into OCP header.php
...
### [completed] T009 [US1] Replace OCP logo with TSiSIP responsive logo in header
...
### [completed] T010 [US1] Update header title and meta tags
**Description**: In `web/common/header.php`, replace generic upstream OCP `<title>` text with "TSiSIP Control Panel" (or localized equivalent via gettext). Add `<meta name="theme-color" content="#1A3A5C">`. Ensure browser tab and mobile chrome reflect TSiSIP branding.
**Phase**: 3
**Depends on**: T008
**Parallel**: [P] with T009
**Acceptance**: Browser tab displays TSiSIP-branded title; mobile theme-color meta is present.

### [completed] T011 [US1] Style Subscriber module tables for readability
...
### [completed] T012 [US1] Implement responsive navigation sidebar
...
### [completed] T013 [US1] Apply TSiSIP branding to login page
...
### [completed] T014 [US2] Create D3.js chart initialization module
...
### [completed] T015 [US2] Implement Dispatcher Load Chart
...
### [completed] T016 [US2] Implement RTPengine Session Chart
...
### [completed] T017 [US2] Validate D3.js + jQuery coexistence
...
### [completed] T018 [US3] Implement role-aware CSS density rules
...
### [completed] T019 [US3] Style Tenant Management and Header Routing forms
...
### [completed] T020 [US3] Set data-tsisip-role attribute on body
...
### [completed] T021 Create TSiSIP English PO source file
...
### [completed] T022 Create TSiSIP Spanish PO translation
...
### [completed] T023 Create TSiSIP Portuguese PO translation
...
### [completed] T024 Integrate locale files with OCP gettext domain
...
### [completed] T025 Run CSS specificity audit
...
### [completed] T026 Run accessibility audit (axe-core)
...
### [completed] T027 Run performance audit (Lighthouse)
...
### [completed] T028 Run visual regression baseline
...
### [completed] T029 Validate rollback safety
...
### [completed] T030 Final documentation and sign-off
