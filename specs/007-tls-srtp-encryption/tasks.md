...
### [completed] T001: Create CA tool container
...
### [completed] T002: Create certificate generation script
...
### [completed] T003: Create certificate rotation script
...
### [completed] T004: Add CA secrets to docker-compose.yml
...
### [completed] T005: Configure OpenSIPS TLS module
...
### [completed] T006: Add TLS listener
...
### [completed] T007: Implement mutual TLS for trunks
...
### [completed] T008: Implement tls_reload via MI
...
### [completed] T009: Add rotation monitoring
...
### [completed] T010: Create rotation integration test
...
### [completed] T011: Configure RTPengine for SRTP
...
### [completed] T012: Update OpenSIPS SDP routes for SRTP
...
### [completed] T013: Handle SDP re-INVITE for SRTP
...
### [completed] T014: Restrict TLS cipher suites
...
### [completed] T015: Restrict SRTP cipher suites
...
### [completed] T016: Create cipher negotiation test
...
### [completed] T017: Create end-to-end TLS registration test
...
### [completed] T018: Add TLS/SRTP Grafana dashboard
...
### [completed] T019: Document TLS/SRTP runbook
