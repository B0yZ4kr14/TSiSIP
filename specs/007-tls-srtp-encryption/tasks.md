...
### [x] T1.1: Create CA tool container
...
### [x] T1.2: Create certificate generation script
...
### [x] T1.3: Create certificate rotation script
...
### [x] T1.4: Add CA secrets to docker-compose.yml
...
### [x] T2.3: Implement mutual TLS for trunks
...
### [x] T3.2: Add rotation monitoring
...
### [x] T3.3: Create rotation integration test
...
### [x] T4.1: Configure RTPengine for SRTP
...
### [x] T4.2: Update OpenSIPS SDP routes for SRTP
...
### [x] T4.3: Handle SDP re-INVITE for SRTP
...
### [x] T5.1: Restrict TLS cipher suites
...
### [x] T5.2: Restrict SRTP cipher suites
...
### [x] T5.3: Create cipher negotiation test
...
### [x] T6.1: Create end-to-end TLS registration test
...
### [x] T6.2: Add TLS/SRTP Grafana dashboard
...
### [x] T6.3: Document TLS/SRTP runbook
