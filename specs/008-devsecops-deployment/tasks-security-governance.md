...
### [pending] SG1.1: Document MSL applicability matrix for TSiAPP deployment
...
### [pending] SG1.2: Declare residual risk register for accepted gaps
...
### [pending] SG2.1: Harmonize backup metrics exporter binding across all compose profiles
...
### [pending] SG2.2: Make nginx config validation runnable in CI without host nginx binary
...
### [pending] SG2.3: Make Ansible syntax-check runnable in CI without host ansible binary
...
### [pending] SG3.2: Produce container image CVE scan evidence
...
### [pending] SG3.3: Produce network isolation verification evidence
...
### [pending] SG3.4: Produce secret-management audit evidence
...
### [pending] SG3.5: Produce Nginx TLS configuration evidence
...
### [pending] SG3.6: Produce health-check validation evidence
...
### [pending] SG4.1: Implement 90-day secret rotation audit trail
...
### [pending] SG4.2: Complete deterministic image pinning across all services
...
### [pending] SG4.3: Document upstream SIP port exposure decision
...
### [pending] SG4.4: Create security incident response runbook
...
### [pending] SG5.1: Create security evidence index
...
### [pending] SG5.2: Update Feature 008 spec status
...
### [pending] SG5.3: Final security governance sign-off
...
docs/security/
  ...
  evidence/
    008-ssl-labs-grade-<date>.html
    008-trivy-scan-latest.json
    008-network-isolation-<date>.txt
    008-secrets-audit-<date>.txt
    008-nginx-tls-<date>.txt
    008-health-checks-<date>.txt

## Quick Reference: Open Items from infra-quality.md

| Item | Checklist Section | SG Task | Status |
|---|---|---|---|
| Backup metrics exporter binding | Network Isolation | SG2.1 | pending |
| nginx syntax validation | Health Check Validation | SG2.2 | pending |
| Ansible syntax-check | Health Check Validation | SG2.3 | pending |
| SSL Labs A+ grade | Security Compliance SC-004b | SG3.1 | pending |
| Image CVE scan artifact | Docker Image Security | SG3.2 | pending |
| Network isolation script | Network Isolation | SG3.3 | pending |
| Secrets audit script | Secret Management | SG3.4 | pending |
| Nginx TLS config script | Nginx TLS Configuration | SG3.5 | pending |
| Health check script | Health Check Validation | SG3.6 | pending |
