...
### [completed] T001: Create OpenSIPS Dockerfile
...
### [completed] T002: Create container entrypoint script
...
### [completed] T003: Create OpenSIPS configuration template
...
### [completed] T004: Validate image build and syntax check
...
### [completed] T005: Generate stock OpenSIPS 3.6 PostgreSQL schema
...
### [completed] T006: Create TSiSIP custom schema extensions
...
### [completed] T007: Create seed data script
...
### [completed] T008: Validate PostgreSQL initialization in container
...
### [completed] T009: Define Docker Compose services and networks
...
### [completed] T010: Configure OpenSIPS service environment and secrets
...
### [completed] T011: Configure RTPengine service command and networking
...
### [completed] T012: Verify network and port isolation
...
### [completed] T013: Create `.env.example` and secrets documentation
...
### [completed] T014: Run Compose config validation
...
### [completed] T015: Run OpenSIPS syntax check inside built image
...
### [completed] T016: Validate unauthenticated OPTIONS handling
...
### [completed] T017: Validate unauthenticated INVITE challenge
...
### [completed] T018: Validate authenticated production routing to Asterisk
...
### [completed] T019: Final documentation update and sign-off
...
### [completed] T020: Implement trusted gateway bypass (FR-001-008)
...
### [completed] T021: Implement auth audit logging (FR-001-009)
...
### [completed] T022: Align auth response code contract (401 vs 407)
