...
description: 'Capability-aware security and QA risk assessment: STRIDE threat models,
  vulnerability classification, control mapping, QA risk analysis, and unified risk
  scoring.'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: brownkit:commands/assess.md
---
...
| **Change velocity** | `normalize(commits_last_6mo, repo_median)` — capped at 1.0 | `.specify/scripts/bash/git-churn.sh` (preferred) or `git log` over capability's files |
