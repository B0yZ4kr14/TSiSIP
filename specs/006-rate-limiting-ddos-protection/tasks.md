...
### [x] T1.3: Add TCP connection limits
...
### [x] T3.1: Configure load-based dispatcher routing
...
### [x] T3.2: Add dispatcher load monitoring
...
### [x] T4.2: Add ban management MI commands
...
### [x] T5.1: Create anomaly detector sidecar
...
### [x] T5.2: Add event routes for anomaly detection
...
### [x] T5.3: Add global throttle on anomaly
...
### [x] T6.1: Create DDoS simulation test
...
### [x] T6.2: Add rate limiting Grafana dashboard
...
### [x] T6.3: Document rate limiting runbook
