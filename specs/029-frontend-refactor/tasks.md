...
### Task 1.1: Create Generic MI Action Handler
...
### Task 1.2: Address Reload Button
...
### Task 1.3: Dialplan Reload Button
- Modify: `web/dialplan.php`
- Add "Reload Dialplan" button
- Same pattern as 1.2

### Task 1.4: Domain Reload Button
- Modify: `web/domains.php`
- Add "Reload Domains" button
- Same pattern as 1.2

### Task 1.5: Dynamic Routing Reload & GW Status
...
### Task 1.6: Dialog Terminate Button
...
### Task 2.1: Memory Status Dashboard
