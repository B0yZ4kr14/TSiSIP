...
- [ ] T34.1.1 Create `web/api/v1/metrics-stream.php` with EventSource headers
- [ ] T34.1.2 Implement OpenSIPS MI proxy (get_statistics, ds_list, dlg_list_count)
- [ ] T34.1.3 Add PostgreSQL trunk health query to SSE endpoint
- [ ] T34.1.4 Integrate anomaly_detector API with X-API-Key auth
- [ ] T34.1.5 Implement 5-second emission loop with connection rate limit
- [ ] T34.1.6 Create `web/api/v1/alerts.php` for Alertmanager proxy
- [ ] T34.1.7 Create `web/api/v1/metrics-history.php` for Prometheus query_range proxy
- [ ] T34.1.8 Add session/auth guards to all API endpoints
...
- [ ] T34.2.4 Build Anomaly Alert Banner (sticky, auto-dismiss, severity colors)
- [ ] T34.2.5 Build Prometheus Alerts widget (sidebar list, auto-refresh)
- [ ] T34.2.6 Build Historical Mini-Charts with D3.js sparklines
- [ ] T34.2.7 Create full-screen System Health page (`web/system-health.php`)
...
- [ ] T34.3.5 Implement SSE reconnection with exponential backoff
...
- [ ] T34.4.4 Write end-to-end SSE streaming integration test
