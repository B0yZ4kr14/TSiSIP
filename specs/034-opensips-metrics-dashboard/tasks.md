...
- [x] T34.2.1 Enhance metric cards with SSE data binding and stale indicator
- [x] T34.2.2 Build Trunk Health widget (table with status, CPS, latency)
- [x] T34.2.3 Build Dispatcher Health widget (grid of destination groups)
- [x] T34.2.4 Build Anomaly Alert Banner (sticky, auto-dismiss, severity colors)
- [x] T34.2.5 Build Prometheus Alerts widget (sidebar list, auto-refresh)
...
- [x] T34.3.1 Integrate widgets into `dashboard.php` with role-based visibility
- [x] T34.3.2 Verify MI HTTP loopback restriction (C4)
- [x] T34.3.3 Verify anomaly detector auth header via Docker env (H2)
...
- [x] T34.4.7 Performance test: 50 concurrent SSE connections
- [x] T34.4.8 Update operator runbook with new dashboard features
