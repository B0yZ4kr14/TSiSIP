...
<div class="tsisip-page">
    <div class="tsisip-page-header">
        ...
        <div class="tsisip-actions">
            <button type="button" class="tsisip-btn tsisip-btn-secondary" onclick="TSiSIPMi.exportData('pike_list', [], 'csv')"><?php echo _('Export CSV'); ?></button>
            <button type="button" class="tsisip-btn tsisip-btn-secondary" onclick="TSiSIPMi.exportData('pike_list', [], 'json')"><?php echo _('Export JSON'); ?></button>
        </div>
    </div>
