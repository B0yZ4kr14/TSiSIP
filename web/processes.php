...
<div class="tsisip-page">
    <div class="tsisip-page-header">
        ...
        <div class="tsisip-actions">
            <button type="button" class="tsisip-btn tsisip-btn-secondary" onclick="TSiSIPMi.exportData('ps', [], 'csv')"><?php echo _('Export CSV'); ?></button>
            <button type="button" class="tsisip-btn tsisip-btn-secondary" onclick="TSiSIPMi.exportData('ps', [], 'json')"><?php echo _('Export JSON'); ?></button>
        </div>
    </div>
