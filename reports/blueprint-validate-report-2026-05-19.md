...
|---|---|---|---|---|---|---|---|---|---|---|
| 001 | 001-opensips-docker-edge-proxy | ✅ | ✅ | ✅ | ✅ | 5 | 5 | 0 | 0 | ✅ PASS |
| 002 | 002-tsisip-ocp-rebrand | ✅ | ✅ | ✅ | ✅ | 8 | 8 | 0 | 0 | ⚠️ WARN |
| 003 | 003-prometheus-grafana-observability | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 004 | 004-health-checks-autohealing | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 005 | 005-postgresql-backup-restore | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 006 | 006-rate-limiting-ddos-protection | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 007 | 007-tls-srtp-encryption | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 008 | 008-devsecops-deployment | ✅ | ✅ | ✅ | ✅ | 8 | 6 | 2 | 5 | ❌ FAIL |
| 009 | 009-vps-deploy-automation | ✅ | ✅ | ✅ | ✅ | 1 | 1 | 0 | 0 | ✅ PASS |
| 010 | 010-ocp-navigation-system-links | ✅ | ✅ | ✅ | ✅ | 3 | 3 | 0 | 0 | ✅ PASS |
| 011 | 011-ocp-forced-password-change | ✅ | ✅ | ✅ | ✅ | 2 | 2 | 0 | 0 | ✅ PASS |
| 012 | 012-ocp-admin-tools-restoration | ✅ | ✅ | ✅ | ✅ | 9 | 9 | 0 | 0 | ✅ PASS |
| 013 | 013-brownfield-follow-up | ✅ | ✅ | ✅ | ✅ | 3 | 3 | 0 | 0 | ✅ PASS |
| 015 | 015-auto-tls-certificate-rotation | ✅ | ✅ | ✅ | ✅ | 8 | 8 | 0 | 0 | ✅ PASS |
| 016 | 016-ocp-audit-log-compliance | ✅ | ✅ | ✅ | ✅ | 8 | 8 | 0 | 0 | ✅ PASS |
| 017 | 017-sip-trunk-provider-integration | ✅ | ✅ | ✅ | ✅ | 6 | 3 | 3 | 0 | ⚠️ WARN |
| 018 | 018-global-requirement-id-migration | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 019 | 019-spec-kit-memory-hub-integration | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 020 | 020-ocp-critical-tool-gap-closure | ✅ | ✅ | ✅ | ✅ | 12 | 12 | 0 | 0 | ✅ PASS |
| 021 | 021-brownfield-security-production-hardening | ✅ | ✅ | ✅ | ✅ | 0 | 0 | 0 | 0 | ✅ PASS |
| 022 | 022-vps-go-live-stabilization | ✅ | ✅ | ✅ | ✅ | 21 | 19 | 2 | 0 | ⚠️ WARN |
| 023 | 023-subscriber-crud-refactor | ✅ | ✅ | ✅ | ✅ | 10 | 10 | 0 | 4 | ❌ FAIL |
| 024 | 024-brownfield-remediation | ✅ | ✅ | ✅ | ✅ | 16 | 16 | 0 | 1 | ⚠️ WARN |
...
- **spec.md**: ✅ Present (17549 bytes)
- **plan.md**: ✅ Present (11600 bytes)
- **tasks.md**: ✅ Present (12789 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 001-opensips-docker-edge-proxy validation passed with no issues
...
- **spec.md**: ✅ Present (15261 bytes)
- **plan.md**: ✅ Present (2810 bytes)
- **tasks.md**: ✅ Present (6549 bytes)

#### Validation Checks

**⚠️ Spec Traceability** — *WARN*
Requirements from blueprint not found in spec.md: FR-002-001, FR-002-002, FR-002-003, FR-002-004, FR-002-005
...
- **spec.md**: ✅ Present (9814 bytes)
- **plan.md**: ✅ Present (3222 bytes)
- **tasks.md**: ✅ Present (7994 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 003-prometheus-grafana-observability validation passed with no issues
...
- **spec.md**: ✅ Present (9441 bytes)
- **plan.md**: ✅ Present (2758 bytes)
- **tasks.md**: ✅ Present (7223 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 004-health-checks-autohealing validation passed with no issues
...
- **spec.md**: ✅ Present (14467 bytes)
- **plan.md**: ✅ Present (4031 bytes)
- **tasks.md**: ✅ Present (10069 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 005-postgresql-backup-restore validation passed with no issues
...
- **spec.md**: ✅ Present (9362 bytes)
- **plan.md**: ✅ Present (2838 bytes)
- **tasks.md**: ✅ Present (6641 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 006-rate-limiting-ddos-protection validation passed with no issues
...
- **spec.md**: ✅ Present (9256 bytes)
- **plan.md**: ✅ Present (3356 bytes)
- **tasks.md**: ✅ Present (9588 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 007-tls-srtp-encryption validation passed with no issues
...
- **spec.md**: ✅ Present (12067 bytes)
- **plan.md**: ✅ Present (2824 bytes)
...
- docs/security/evidence/008-ssl-labs-grade-20260519.html
- docs/security/evidence/008-trivy-scan-latest.json
...
**✅ Overall** — *PASS*
Blueprint 009-vps-deploy-automation validation passed with no issues
...
- **spec.md**: ✅ Present (4182 bytes)
- **plan.md**: ✅ Present (898 bytes)
- **tasks.md**: ✅ Present (3283 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 010-ocp-navigation-system-links validation passed with no issues
...
- **spec.md**: ✅ Present (4660 bytes)
- **plan.md**: ✅ Present (1131 bytes)
- **tasks.md**: ✅ Present (1196 bytes)
...
- **spec.md**: ✅ Present (5164 bytes)
- **plan.md**: ✅ Present (4464 bytes)
- **tasks.md**: ✅ Present (3203 bytes)
...
- **spec.md**: ✅ Present (1518 bytes)
- **plan.md**: ✅ Present (2350 bytes)
- **tasks.md**: ✅ Present (1367 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 013-brownfield-follow-up validation passed with no issues
...
- **spec.md**: ✅ Present (18097 bytes)
- **plan.md**: ✅ Present (5273 bytes)
- **tasks.md**: ✅ Present (8418 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 015-auto-tls-certificate-rotation validation passed with no issues
...
- **spec.md**: ✅ Present (22788 bytes)
- **plan.md**: ✅ Present (5171 bytes)
- **tasks.md**: ✅ Present (8283 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 016-ocp-audit-log-compliance validation passed with no issues
...
- **spec.md**: ✅ Present (23648 bytes)
- **plan.md**: ✅ Present (7434 bytes)
- **tasks.md**: ✅ Present (14551 bytes)
...
- **spec.md**: ✅ Present (2795 bytes)
- **plan.md**: ✅ Present (625 bytes)
- **tasks.md**: ✅ Present (1727 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 018-global-requirement-id-migration validation passed with no issues
...
- **spec.md**: ✅ Present (4584 bytes)
- **plan.md**: ✅ Present (4364 bytes)
- **tasks.md**: ✅ Present (3018 bytes)
...
- **spec.md**: ✅ Present (6587 bytes)
- **plan.md**: ✅ Present (6318 bytes)
- **tasks.md**: ✅ Present (9913 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 020-ocp-critical-tool-gap-closure validation passed with no issues
...
- **spec.md**: ✅ Present (2561 bytes)
- **plan.md**: ✅ Present (1283 bytes)
- **tasks.md**: ✅ Present (1020 bytes)

#### Validation Checks

**✅ Overall** — *PASS*
Blueprint 021-brownfield-security-production-hardening validation passed with no issues
...
- **spec.md**: ✅ Present (7004 bytes)
- **plan.md**: ✅ Present (2304 bytes)
- **tasks.md**: ✅ Present (8205 bytes)
...
- **spec.md**: ✅ Present (8167 bytes)
- **plan.md**: ✅ Present (8349 bytes)
- **tasks.md**: ✅ Present (5290 bytes)
...
- **spec.md**: ✅ Present (3366 bytes)
- **plan.md**: ✅ Present (3835 bytes)
- **tasks.md**: ✅ Present (5550 bytes)

#### Validation Checks

**⚠️ Implementation Drift** — *WARN*
1 blueprint change(s) not detected in implementation
- T1.1 (docker/admin-api/Dockerfile): After code not detected (key lines: 0/1)
...
❌ **T1.1** (`docker/admin-api/Dockerfile`) — After code not detected (key lines: 0/1)
✅ **T1.2** (`docker/admin-api/Dockerfile`) — Significant lines found (2/3)
...
✅ **T4.3** (`.env.example`) — After code block found exactly in file
✅ **T5.3** (`docker/admin-api/Dockerfile`) — Significant lines found (4/5)
...
✅ **T5.7** (`docker/certbot-exporter/Dockerfile`) — After code block found exactly in file
...
**024 — 024-brownfield-remediation** (1 items):
- `T1.1` in `docker/admin-api/Dockerfile`: After code not detected (key lines: 0/1)

---

*Report generated by TSiSIP Blueprint Validation*
*Timestamp: 2026-05-25T20:33:23.217384*