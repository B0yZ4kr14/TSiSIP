...
class TestDIDRouting:
    ...
    def test_did_002_not_found(self):
        ...
        psql("INSERT INTO sip_trunk_providers (name, host, port, transport, enabled, priority) VALUES ('test-trunk', '172.24.0.4', 5060, 'udp', true, 1) ON CONFLICT DO NOTHING;")
...
msg = (
    ...
    b'Via: SIP/2.0/UDP 172.24.0.4:15092;branch=z9hG4bK-did002\\r\\n'
    b'From: <sip:trunk@172.24.0.4>;tag=trunktag\\r\\n'
    b'To: <sip:+19999999999@opensips:5060>\\r\\n'
    b'Call-ID: did-002-test@172.24.0.4\\r\\n'
    b'CSeq: 1 INVITE\\r\\n'
    b'Max-Forwards: 70\\r\\n'
    b'Contact: <sip:trunk@172.24.0.4:15092>\\r\\n'
    b'Content-Length: 0\\r\\n\\r\\n'
)
try:
