...
### T001: Create trunk provider schema file
...
### T003: Add Docker secret for credential encryption
...
### T004: Create secret placeholder and env documentation
...
### T005: Validate schema idempotency
...
## Phase 2: OpenSIPS Module Configuration

### T006: Load uac modules conditionally
...
### T007: Configure uac_registrant module parameters
...
### T008: Configure dispatcher trunk probe set
...
### T009: Update entrypoint for trunk secret
...
### T010: Validate OpenSIPS config syntax
...
## Phase 3: Outbound Routing Logic

### T011: Implement TRUNK_ROUTING route
...
### T012: Implement TRUNK_FAILOVER failure route
...
### T013: Implement per-trunk CPS rate limiting
...
### T014: Add SRTP branch route for trunk calls
...
### T015: Enrich CDR with trunk metadata
...
### T016: Wire TRUNK_ROUTING into main request route
...
## Phase 4: Inbound DID Routing

### T017: Implement INBOUND_DID_ROUTING route
...
### T018: Wire INBOUND_DID_ROUTING into main request route
...
### T019: Add topology hiding for inbound trunk calls
...
### T020: Handle unknown DID responses
...
### T021: Populate dispatcher trunk probe destinations
...
### T022: Implement dispatcher health event handler
...
### T023: Filter unhealthy trunks from selection
...
### T024: Add Prometheus trunk metrics
...
### T025: Create Grafana trunk dashboard
...
## Phase 6: OCP Admin Pages

### T026: Add trunk pages to OCP navigation
...
### T027: Create trunk provider CRUD page
...
### T028: Create DID mapping CRUD page
...
### T031: Update OCP container for secret access
...
### T036: Health probe exclusion test
